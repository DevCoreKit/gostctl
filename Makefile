...
android:
	gogio -x -work -target android -minsdk 22 -targetsdk 35 -version $(VERSION).2 -name GOST -signkey build/sign.keystore -signpass android -appid gost.run -o $(BINDIR)/$(NAME)-$(VERSION).aab .
	gogio -x -work -target android -minsdk 22 -targetsdk 35 -version $(VERSION).2 -name GOST -signkey build/sign.keystore -signpass android -appid gost.run -o $(BINDIR)/$(NAME)-$(VERSION).apk .
